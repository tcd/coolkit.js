export type IdentifierFunction<T> = (element: T) => boolean
export type ChangerFunction<T>    = (element: T) => T
 ...
 */
const updateArray = <T>({ array, finder, changer }: UpdateArrayOptions<T>): T[] => {
